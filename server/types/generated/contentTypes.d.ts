...
export interface ApiBasketItemBasketItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    basket: Schema.Attribute.Relation<'manyToOne', 'api::basket.basket'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiBasketBasket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    basketItem: Schema.Attribute.Relation<
      'oneToMany',
      'api::basket-item.basket-item'
    >;
    basketItems: Schema.Attribute.Relation<'oneToMany', 'api::basket.basket'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroImage: Schema.Attribute.Media<'files' | 'images', true>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    spotCategories: Schema.Attribute.Relation<
      'oneToOne',
      'api::category.category'
    >;
    spotImages: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    spotsText: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    products: Schema.Attribute.Relation<'manyToMany', 'api::basket.basket'>;
    publishedAt: Schema.Attribute.DateTime;
    shippingAdress: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    basketItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::basket-item.basket-item'
    >;
    ...
    description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'>;
    favorite: Schema.Attribute.Relation<'oneToMany', 'api::favorite.favorite'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    basket: Schema.Attribute.Relation<'oneToOne', 'api::basket.basket'>;
